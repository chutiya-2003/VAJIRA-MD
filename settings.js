...
global.owner = process.env.OWNER_NUMBER  || '94701992015' ;  // ADD YOUR NUMBER WITHOUT +94751322602
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'youre session id' ,VAJIRA-MD=yUN2iTAL#jZOFv71ncurJ4J153OxyMQ13--htVp0-ILPzNaRyYMY
